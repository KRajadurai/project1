...
CREATE TABLE `user_roles` (
  ...
  CONSTRAINT `FK8j1hw00sci6ft982pulb5n06q` FOREIGN KEY (`userID`) REFERENCES `users` (`id`),
  CONSTRAINT `FKji47nlsswey30e4s67uahy9ch` FOREIGN KEY (`roleID`) REFERENCES `roles` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'rajadurai','$2a$10$EpmsM0/vl1uxQKyt2GDF2OG7sa27TDuq63D6ElBgbmV8L2L1tSXFS',NULL,'Rajadurai K'),(1989,'Manikandan','4a06d868d044c50af0cf9bc82d2fc19f',102,'Manikandan'),(1991,'Ramakrishnan','4a06d868d044c50af0cf9bc82d2fc19f',101,'Ramakrishnan'),(2709,'Govindharaj','f5c3dd7514bf620a1b85450d2ae374b1',101,'Govindharaj');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'phase1'
--
...
-- Dump completed on 2018-05-20 14:44:44
